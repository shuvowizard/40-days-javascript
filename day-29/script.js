...
// Encapsulation is the bundling of data and methods that operate on that data into a single unit, usually a class — and restricting the direct access to some of the object’s components. 
...
// Encapsulation  ── Bundle + protect state, Restriction.
