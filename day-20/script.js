...
//? Range
// A range represents a fragment of a document that is between two boundary points.
...
range.setEnd(p.childNodes[2], 4)  // to "and"
...
function addItems(count) {
  ...
  //? Mutation Observer 
  // The mutation observer is an built-in javascript API that lets you observe changes to a DOM element or sub tree and then help you to react to it via a callback function.
